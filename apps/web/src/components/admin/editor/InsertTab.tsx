...
export function InsertTab({
  ...
  return (
    <div className="relative flex h-[92px] items-stretch overflow-x-auto bg-white">
      {/* ---------------- Tables ---------------- */}
      <Group label="Table" launchTitle={ax("টেবিল ডায়ালগ")} onLaunch={() => openDialog("table")}>
        <IconCombo
      ...
      <Group label="Illustrations">
        <BigBtn
          title={ax("ছবি — ক্যাপশন, কৃতিত্ব ও alt সহ")}
          label="Picture"
          icon={<ImageIcon className="h-5 w-5" />}
          onClick={() => openDialog("image")}
        />
        <BigBtn
          title={ax("YouTube ভিডিও বসান")}
          label="Video"
      ...
      <Group label="Links">
        <Stack>
          ...
          />
          <LabelBtn
            title={ax("বুকমার্ক — খবরের ভেতরে লাফ দেওয়ার জায়গা")}
            label="Bookmark"
      ...
      <Group label="Text">
        <BigBtn
          title={ax("ফ্যাক্ট বক্স — খবরের পাশে আলাদা বাক্স")}
          label="Text Box"
        ...
        />
        <BigBtn
          title={ax("ড্রপ ক্যাপ — অনুচ্ছেদের প্রথম অক্ষর বড়")}
          label="Drop Cap"
