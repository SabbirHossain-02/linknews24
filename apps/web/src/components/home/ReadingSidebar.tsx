...
export function ReadingSidebar({
  ...
  return (
    <aside className="sticky top-[190px] flex max-h-[calc(100vh-190px-2rem)] flex-col overflow-hidden rounded-xl border border-border bg-background shadow-[0_1px_2px_rgba(20,24,31,0.04),0_8px_24px_rgba(20,24,31,0.06)]">
